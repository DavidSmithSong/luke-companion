...
SYSTEM_PROMPT = """你是一位陪伴普通老人读圣经的贴心助手。
你的读者是中国大陆的退休老人家（如爸爸初中水平，妈妈小学三年级水平），他们需要亲切、通俗但又不失庄重、有细节的讲解。
写作要求：
- 风格：采用有叙述感、厚重感与温度的讲故事风格，不要像两个年轻人在随意闲聊。
- 禁用词：绝对不要出现"咱们"、"大老远"、"生娃"、"老天爷"、"老人家们"等过于随意的口语俗词。
- 称谓：称呼上帝为"上帝"或"神"，称呼读者为"您"或"你们"，语气温和且有礼貌。
- 语言：不使用任何神学术语或宗派色彩强的词汇（如"救赎论"、"护理"、"末世论"、"属灵"等），把深奥的道理融入具体的历史事实和生活故事中。
- 格式：简体中文，严格按照指定的部分和字数区间输出。"""
...
1. **历史文化背景**（500字到800字之间）
   详细且有画面感地讲述这章经文的历史与地理背景。
   - 如果是第2章，请着重展开罗马皇帝普查背景与长途迁徙的距离、马槽出生的实际社会背景与降卑意义、牧羊人在当时的社会边缘地位、西面和亚拿等候弥赛亚的传统与律法奉献规矩。
   - 如果是第3章（主题：两代人的和解、旷野修直道路与身份的洗礼），请展开交代章首提及的罗马分封王（提庇留、彼拉多、希律等）对当时百姓的重压、旷野的险恶地理与人们出城听道的渴望、施洗约翰如何通过“父亲的心转向儿女”促进家庭两代人和解、以及约旦河洗礼作为新生命起点的社会文化象征。
   - 如果是第4章（主题：战胜生活的试探与面对故乡拒绝的释怀），请详细描绘犹太旷野（寸草不生、危险荒凉）的恶劣环境与耶稣禁食受试探的艰辛、拿撒勒会堂的礼拜细节与宣读以赛亚书卷的规矩、以及故乡乡亲在听到耶稣提及撒勒法寡妇和叙利亚乃缦等“外邦人蒙恩”的历史事实时，因狭隘偏见而愤怒排斥耶稣的真实背景。
   语言要有叙事感、厚重感与温度，绝对不能出现禁用口语词。以"那个时候……"或"在那个时代……"开头，像讲故事一样娓娓道来。

2. **平行参考**（300字到500字之间）
   对比其他福音书中对相同事件的记述，清晰对比两者的视角侧重点。
   - 如果是第2章，请重点对比马太的“君王视角”（东方博士、王室家谱、逃往埃及）与路加的“平民/人子视角”（牧羊人、马槽、律法洁净奉献、耶稣十二岁在圣殿），体现上帝对普通人、委屈者的体贴。例如对比金银乳香 vs 斑鸠雏鸽的简朴。
   - 如果是第3章，对比马太/马可侧重约翰对“毒蛇的种类”的严厉警示和审判，而路加独家且详细记录了约翰对不同职业普通人的生活实践教导：吩咐收税的不要多收、当兵的不要强索、普通百姓要分享多余的衣物和食物。突出路加福音对普通百姓日常生计、公平诚实生活的深切体贴。
   - 如果是第4章，对比马太的试探顺序（以高山展现万国权柄为终结，强调耶稣作为荣耀君王对权势的拒绝）与路加的试探顺序（以耶路撒冷圣殿殿顶为终结，将最高潮落在对神儿子身份的终极考验，强调纯粹的信靠与顺服）。同时对比其他福音书中耶稣被故乡人排斥的零星记录，说明路加特意将“拿撒勒被拒”放在耶稣传道生涯的最开端，作为整本书的基调——祂就是那位为了寻找卑微、被边缘化之人而来，并情愿承担被至亲同胞拒绝的忧患之子。
   如果本章内容在其他福音书中没有平行段落，就写"本章内容为路加独有"并说明其独特的文学与神学价值。

3. **现代类比**（2个，每个100字左右）
   把本章的核心场景或人物，类比为今天中国日常生活中的情境，需要带有叙事温度和亲情体验。
   - 如果是第2章：
     - 类比1：将普查的长途迁徙类比为中国春运或艰苦的大西北返乡，体会约瑟和马利亚在快要生育时的艰辛与不易。
     - 类比2：将西面和亚拿的终身等候，类比为村头望眼欲穿守候儿女归家的老父亲或老母亲，见到那一幕时心里的亮堂与释怀。
   - 如果是第3章：
     - 类比1：约翰教导人们分给穷人衣服和食物、不强索财务，类比为在老家村子里，邻里之间互帮互助、不占人便宜、借了农具及时归还的厚道家风。
     - 类比2：在约旦河洗手受洗开启新道路，类比为在年底除夕夜前全家大扫除，扫去一年的尘土和不快，洗净双手和过去的心结，清清爽爽地迎接新年。
   - 如果是第4章：
     - 类比1：石头变面包的物质诱惑，类比为早年间过苦日子时，面对别人给的捷径或小便宜，虽然家里正等米下锅，却依然坚守良心与本分，选择不拿昧心钱。
     - 类比2：耶稣在故乡拿撒勒被邻里嘲讽拒绝（“这不是约瑟的儿子吗？”），类比为一个大山里走出去的读书人，回到村里想做些实事、说些真心话，却被守旧的亲戚用旧眼光嘲笑排挤，心里感到委屈，但最终选择理解对方的局限并释怀。

4. **思考问题**（3个）
   - 问题要具体、有温度，引导老人家将经文与自己的人生经历、长辈晚辈关系或亲情体验相结合。
   - 不要出现"属灵""蒙恩""神的旨意"等任何宗教术语。
   - 必须是温柔的、邀请式的提问，引发感性回忆。
   - 每个问题不超过80字。
...
CHAPTER_PAINTINGS = {
    ...
    3: (
        "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Piero_della_Francesca_-_The_Baptism_of_Christ_-_Google_Art_Project.jpg/1280px-Piero_della_Francesca_-_The_Baptism_of_Christ_-_Google_Art_Project.jpg",
        "皮耶罗·德拉·弗朗切斯卡《基督受洗》，约1448-1450年，伦敦国家美术馆藏",
    ),
    4: (
        "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Kramskoy_Christ_in_the_Wilderness.jpg/1280px-Kramskoy_Christ_in_the_Wilderness.jpg",
        "伊凡·克拉姆斯柯依《旷野中的基督》，1872年，莫斯科特列季亚科夫画廊藏",
    ),
}
